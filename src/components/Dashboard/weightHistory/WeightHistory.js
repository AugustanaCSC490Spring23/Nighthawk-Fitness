  ...
  return (
    <div className='weight-history'>
        ...
        <div className="history-item tabs">
            ...
            <div className="history-content">
                <h3>{!userData.information ? 'No History': userData.information.weight.length >= 2  ? userData.information.weight[userData.information.weight.length - 2].w : 'No History'}</h3>
